...
BLOG_AUTHOR = "KOUNOIKE Yuusuke"  # (translatable)
BLOG_TITLE = "こーのいけのGitHub Pages"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kounoike.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kounoike.github.io/"
BLOG_EMAIL = "kounoike.yuusuke@gmail.com"
BLOG_DESCRIPTION = "こーのいけのGitHub Pages powered by Nikola."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', 'ホーム', 'icon-home'),
        ('/archive.html', '文書一覧', 'icon-folder-open-alt'),
        ('/categories/index.html', 'タグ', 'icon-tags'),
        ('/rss.xml', 'RSSフィード', 'icon-rss'),
        ('https://kounoike.github.io', 'About me', 'icon-user'),
        ('https://twitter.com/ko_noike', 'My Twitter', 'icon-twitter'),
        ('https://github.com/kounoike', 'My Github', 'icon-github'),
    )
}

# Name of the theme to use.
THEME = "zen-jinja-custom"
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-571a890cfb0979b4"></script>
<!-- End of social buttons -->
"""
...
import re
TEASER_REGEXP = re.compile('<!--\s*more(:(.+))?\s*-->', re.IGNORECASE)
